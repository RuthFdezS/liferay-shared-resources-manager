...
public class AssetLocationCacheModel implements CacheModel<AssetLocation>,
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof AssetLocationCacheModel)) {
			return false;
		}

		AssetLocationCacheModel assetLocationCacheModel = (AssetLocationCacheModel)obj;

		if (assetLocationId == assetLocationCacheModel.assetLocationId) {
			return true;
		}
	...
	@Override
	public int hashCode() {
		return HashUtil.hash(0, assetLocationId);
	}
