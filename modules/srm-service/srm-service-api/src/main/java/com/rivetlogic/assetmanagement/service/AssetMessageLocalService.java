...
public interface AssetMessageLocalService extends BaseLocalService,
	...
	*/
	...
	public AssetMessage addAssetMessage(ThemeDisplay themeDisplay,
		ServiceContext serviceContext, AssetMessage assetMessage,
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public AssetMessage fetchAssetMessageByUuidAndGroupId(
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public AssetMessage getAssetMessageByUuidAndGroupId(java.lang.String uuid,
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<AssetMessage> getAssetMessages(long assetId, long userId,
		int start, int end);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<AssetMessage> getAssetMessagesByUuidAndCompanyId(
