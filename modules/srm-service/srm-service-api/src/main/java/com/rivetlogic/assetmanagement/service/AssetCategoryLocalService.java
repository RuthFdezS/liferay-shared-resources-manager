...
public interface AssetCategoryLocalService extends BaseLocalService,
	...
	*/
	...
	public AssetCategory addAssetCategory(ThemeDisplay themeDisplay,
		ServiceContext serviceContext, AssetCategory assetCategory)
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<AssetCategory> getAssetCategories(long groupId, long companyId,
