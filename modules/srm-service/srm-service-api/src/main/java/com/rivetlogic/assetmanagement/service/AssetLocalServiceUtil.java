...
public class AssetLocalServiceUtil {
	...
	*/
	public static java.util.List<com.rivetlogic.assetmanagement.model.Asset> getAssetsByUuidAndCompanyId(
	...
	*/
	public static java.util.List<com.rivetlogic.assetmanagement.model.Asset> getAssetsByUuidAndCompanyId(
		...
		return getService()
				   .getAssetsByUuidAndCompanyId(uuid, companyId, start, end,
			orderByComparator);
	}
